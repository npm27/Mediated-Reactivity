...
<form id="content" class="basicInfo" name="Demographics"
    ...
    <fieldset>
        ...
        <section class="consent">
            <legend><h3>Informed Consent</h3></lege
            <textarea readonly>The purpose of this study is to examine various factors that influence recognition memory. You will be shown words pairs presented on a computer screen and will be asked to complete a judgment task involving the words. Your memory for the words will then be tested. The experiment will take approximately 30 minutes to complete and you will be compensated at a rate of $8.00/hour ($4.00/half-hour session). The researchers do not expect any risks from participating in this study other than the possibility of slight boredom duribng task completion. Your participation will be kept confidential, and you are free to discontinue at anytime. Your data will be deleted immediately after you withdraw. This project and the consent form have been reviewed the Institutional Review Board at the University of Southern Mississippi. Any questions should be directed to nicholas.maxwell@usm.edu</textarea>
            <label>
